...
namespace Velentr.Sprite
{
    ...
    public static class DrawAtlasExtensions
    {
        ...
        public static void Draw(this SpriteBatch spriteBatch, TextureAtlas atlas, string texture, Vector2 position, Color color)
        {
            atlas.Draw(spriteBatch, texture, position, color);
        }
        ...
        public static void Draw(this SpriteBatch spriteBatch, TextureAtlas atlas, string texture, Rectangle destinationRectangle, Rectangle? sourceRectangle, Color color, float rotation, Vector2 origin, SpriteEffects effects, float layerDepth)
        {
            atlas.Draw(spriteBatch, texture, destinationRectangle, sourceRectangle, color, rotation, origin, effects, layerDepth);
        }
        ...
        /// <param name="effects">          The effects. </param>
        /// <param name="layerDepth">       Depth of the layer. </param>
        public static void Draw(this SpriteBatch spriteBatch, TextureAtlas atlas, string texture, Vector2 position, Rectangle? sourceRectangle, Color color, float rotation, Vector2 origin, float scale, SpriteEffects effects, float layerDepth)
        {
